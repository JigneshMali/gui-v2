...
Page {
    ...
    property VeQuickItem sfkV4H2FirmwareReleaseText: VeQuickItem {
        uid: root.bindPrefix + "/H2Device/SFKV4H2FirmwareReleaseText"
    }
    property VeQuickItem sfkV4H2Url: VeQuickItem {
        uid: root.bindPrefix + "/H2Device/SFKV4H2Url"
    }
    property VeQuickItem sfkV4H2DownloadProgress: VeQuickItem {
        uid: root.bindPrefix + "/H2Device/SFKV4H2DownloadProgress"
    }
    property VeQuickItem sfkV4H2DownloadConfirm: VeQuickItem {
        uid: root.bindPrefix + "/H2Device/SFKV4H2Downloadconfirm"
    }
    property VeQuickItem sfkV4H2DownloadCompleted: VeQuickItem {
        uid: root.bindPrefix + "/H2Device/SFKV4H2DownloadCompleted"
    }
    property VeQuickItem sfkV4H2Date: VeQuickItem {
        uid: root.bindPrefix + "/H2Device/SFKV4H2Date"
    }
    ...
    GradientListView {
        model: VisibleItemModel {
            ...
            ListText {
                text: qsTr("Version")
                secondaryText: sfkV4H2version.value
                preferredVisible: pageVisible && sfkV4H2version.value !== ""
            }

            ListButton {
                text: qsTr("Download %1").arg(sfkV4H2version.value)
                secondaryText: sfkV4H2DownloadCompleted.value === 1
                        ? qsTr("Downloaded")
                        : sfkV4H2DownloadProgress.value > 0
                            ? qsTr("Downloading... %1%").arg(sfkV4H2DownloadProgress.value)
                            : qsTr("Download")
                preferredVisible: pageVisible && sfkV4H2version.value !== ""
                onClicked: {
                    if (sfkV4H2DownloadProgress.value === 0 && sfkV4H2DownloadCompleted.value !== 1)
                        sfkV4H2DownloadConfirm.setValue(1)
                }
            }
            ...
            ListButton {
                ...
                secondaryText: h2DeviceFirmwareFlashBar.value === 100
                        ...
                        : loopTestValue.value === 1
                            ? qsTr("Flashing... %1%").arg(h2DeviceFirmwareFlashBar.value)
                            : qsTr("Update")
                preferredVisible: pageVisible && sfkV4H2version.value !== "" && sfkV4H2DownloadCompleted.value === 1
                // onClicked: {
            ...
            ListText {
                text: qsTr("Release Notes- [%1]").arg(sfkV4H2Date.value)
                preferredVisible: pageVisible && sfkV4H2version.value !== ""
            }

            ListText {
                text: sfkV4H2FirmwareReleaseText.value
                preferredVisible: pageVisible && sfkV4H2version.value !== ""
            }
        }
    }
